...
\begin{table}
	...
	\begin{tabular}{cclcc}
		\toprule
		类型 & 计算方法 & 项目 & 小尺寸占比 & 大尺寸占比\\
		\midrule
		 GPU Activities& 快速傅里叶变换 & CUDA memcpy DtoH & 4.93\% & 31.74\%\\
		 &				&  CUDA memcpy HtoD & 3.85\% & 31.17\%\\
		 &				&  void regular\_fft & 16.88\% & 4.25\%\\
		 & 直接(纹理内存)&  CUDA memcpy DtoH & 0.19\% & 0.94\%\\
		...
		\midrule
		API Calls &快速傅里叶变换 &cudaFree &70.71\% & 59.42\% \\
				  &				& cudaMalloc & 28.38\% & 36.67\%\\
				  &				& cudaDeviceSynchronize &0.12\% & 1.30\%\\
				  &直接(纹理内存)& cudaFree & 0.08\% & 0.05\%\\
